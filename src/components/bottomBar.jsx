...
const BottomBar = () => {
  ...
  return (
    <div
      className={`fixed bottom-2 left-1/2 -translate-x-1/2 w-[90%] max-w-md 
        bg-white/60 backdrop-blur-md rounded-2xl shadow-lg flex justify-between 
        items-center px-2 py-2 sm:hidden z-50 border border-gray-200 
    ...
    >
      <Link
        to="/"
        className="flex flex-col items-center text-darkbluex hover:text-lightblue transition"
      >
